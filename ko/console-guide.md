...
![img](http://static.toastoven.net/prod_search/indexing_procedure_01-ko-20200304.jpg)
![img](http://static.toastoven.net/prod_search/indexing_procedure_02-ko-20200304.jpg)<br>
...
- 색인 API
    - Request
        - 파일 업로드 방식
            ```
            curl -XPOST 'https://api-7ab1617e2df0f1d1-search.cloud.toast.com/indexing/v1.0/appkeys/EMKPutYozUttWVY2/serviceids/test/indexing' -H 'Accept-Language:ko' -H 'Content-Type:multipart/form-data; charset=UTF-8' -F 'file=@documents.json'
                ```
        - 페이로드(payload) 방식
            ```
            curl -XPOST 'https://api-7ab1617e2df0f1d1-search.cloud.toast.com/indexing/v1.0/appkeys/EMKPutYozUttWVY2/serviceids/test/indexing' -H 'Accept-Language:ko' -H 'Content-Type:application/json; charset=UTF-8' -d '
            [
              {
                "action": "add",
                "id": "id-1",
...
- 색인 결과 확인 API
    - Request
        ```
        curl -i -XGET 'https://api-7ab1617e2df0f1d1-search.cloud.toast.com/indexing/v1.0/appkeys/EMKPutYozUttWVY2/serviceids/test/indexing_log?id=1' -H 'Accept-Language:ko'
        ```
...
![img](http://static.toastoven.net/prod_search/basic-search-ko-20200304.jpg)<br>
...
- Request
    ```
    curl -G -XGET 'https://api-7ab1617e2df0f1d1-search.cloud.toast.com/search/v1.0/appkeys/EMKPutYozUttWVY2/serviceids/test/search?start=1&size=10&q_option=and,body*1.0,title*1.0&return=&passage.body=180&passage.title=180' -H 'Accept-Language:ko' --data-urlencode q='나이키 운동화' --data-urlencode highlight='<b>,</b>' -H 'Accept-Language:ko'
    ```
- Response
    ```
    {
...
- Request
    ```
    curl -i -XGET 'http://api-7ab1617e2df0f1d1-search.cloud.toast.com/stats/v1.0/appkeys/EMKPutYozUttWVY2/serviceids/test/stats?kind=total_query_count&date=2020-03-09' -H 'Accept-Language:ko'
    ```
    - kind
...
![img](http://static.toastoven.net/prod_search/field_delete-1-ko-20200304.jpg)
![img](http://static.toastoven.net/prod_search/field_delete-2-ko-20200304.jpg)
![img](http://static.toastoven.net/prod_search/field_delete-3-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/filtering-field-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/filtering-search-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/geolocation-field-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/geolocation-search-circle-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/geolocation-search-polygon-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/sorting-search-ko-20200304.jpg)

### 요약

**필드 설정**

![img](http://static.toastoven.net/prod_search/aggregation-field-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/aggregation-search-ko-20200304.jpg)
...
![img](https://static.toastoven.net/prod_search/boolean_query-field-ko-20200304.jpg)
...
![img](https://static.toastoven.net/prod_search/boolean_query-search-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/document_boosting-field-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/document_boosting-search-ko-20200304.jpg)
...
- doc_weight_ratio 파라미터를 이용해서 반영 비율을 조정합니다.
    ```
    curl -G -XGET 'https://api-7ab1617e2df0f1d1-search.cloud.toast.com/search/v1.0/appkeys/EMKPutYozUttWVY2/serviceids/test/search?start=1&size=10&q_option=and,title*1.0&return=&passage.title=180&doc_weight_ratio=0.1' --data-urlencode q='나이키' --data-urlencode highlight='<b>,</b>' -H 'Accept-Language:ko'
    ```
...
- similarity_ratio 파라미터를 이용해서 반영 비율을 조정합니다.
    ```
    curl -G -XGET 'https://api-7ab1617e2df0f1d1-search.cloud.toast.com/search/v1.0/appkeys/EMKPutYozUttWVY2/serviceids/test/search?start=1&size=10&q_option=and,title*1.0&return=&passage.title=180&similarity_ratio=0.1' --data-urlencode q='나이키' --data-urlencode highlight='<b>,</b>' -H 'Accept-Language:ko'
    ```
    - 0.0~1.0 사이의 값을 입력할 수 있습니다.
    - default는 1.0입니다.
...
![img](http://static.toastoven.net/prod_search/document_ranking-field-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/document_ranking-search-ko-20200304.jpg)
...
![img](https://static.toastoven.net/prod_search/field-download-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/field_type-ko-20200304.jpg)
...
![img](http://static.toastoven.net/prod_search/analyzer-ko-20200304.jpg)
